...
import 'package:movie_catalog/media/external/tmdb/data_source/movies/credits_movie_datasource.dart';
...
void main() {
  ...
  test('test if Tmdb credit serialize is working', () async {
    when(() => client.get(any())).thenAnswer((invocation) async =>
        Response(jsonEncode(MOCK_CREDIT_MOVIE_RESPONSE_200), 200, headers: {
          HttpHeaders.contentTypeHeader: 'application/json; charset=utf-8',
        }));
    final result = await dataSource();
    expect(result, isA<CreditEntity>());
  });
  test('test if creditDataSource throws error when response is not ok',
      () async {
    when(() => client.get(any())).thenAnswer((invocation) async =>
...
const MOCK_CREDIT_MOVIE_RESPONSE_200 = {
  "id": 550,
  "cast": [
    {
      "adult": false,
