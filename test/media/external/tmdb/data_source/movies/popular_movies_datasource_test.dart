...
import 'package:movie_catalog/media/external/tmdb/data_source/movies/popular_movies_datasource.dart';
...
void main() {
  ...
  test('Test if popular media serialize is working', () async {
    when(() => client.get(any())).thenAnswer((invocation) async => Response(
            jsonEncode(TMDB_MOCK_POPULAR_MOVIES_RESPONSE_200), 200,
            headers: {
  ...
  test('test if popularDataSource throws error when response is not ok',
      () async {
...
const TMDB_MOCK_POPULAR_MOVIES_RESPONSE_200 = {
  "page": 1,
  "results": [
    {
...
const TMDB_MOCK_RESPONSE_401 = {
  "status_message": "Invalid API key: You must be granted a valid key.",
  "success": false,
  "status_code": 7
};

const TMDB_MOCK_RESPONSE_404 = {
