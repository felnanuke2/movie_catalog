...
class TmdbOnAirMoviesDatasource implements MediaDataSource {
  final Client _client;
  int page = 0;
  TmdbOnAirMoviesDatasource(this._client);

  @override
  Future<List<MediaEntity>> call() async {
    var request = await _client.get(Uri.parse(
        'https://api.themoviedb.org/3/movie/now_playing?api_key=$TMDB_API_KEY&language=pt-br&page=${++page}'));
